...
def specific_train(csvs_path, trainer_asks):
...
def train():
    ...
    try:
        table_specific(csvs_paths, trainer_asks)
        specific_train(csvs_paths, trainer_asks)
    ...
    trainer_asks.train([
        ...
        "Sim",
        "Perguntas gerais sobre um arquivo, como: {}".format(", ".join(asks_geral)),
