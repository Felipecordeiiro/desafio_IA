...
def train():
    ...
    asks_tabelas = {
        'Dados da Companhia,Balanço Patrimonial - Consolidado','Demonstração do Resultado - Consolidado',Demonstração do Fluxo de Caixa - Consolidado,Posição Acionária*,Ações em Circulação no Mercado - 28/04/2023,Composição do Capital Social - 25/04/2023
    }
    trainer_asks.train(
